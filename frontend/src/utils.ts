import { createIcons, Crosshair, LayoutDashboard, Cpu, FolderTree, History, MapPin, ChevronRight, ChevronLeft, ChevronUp, ChevronDown, FolderOpen, RefreshCw, Bell, Settings, Plus, Play, X, Trash2, Download, Upload, Map as MapIcon, Terminal, Activity, Database, CheckCircle2, AlertCircle, HelpCircle, ExternalLink, Users, User, Edit, Home, Lock, Unlock, Globe, FileCheck, Folder, LayoutGrid, List, Filter, UploadCloud, CornerDownRight, Check, Map, Save, Pentagon, FileText, Archive, FileSpreadsheet, ArrowUpDown, ShieldAlert, ArchiveX, ShieldCheck, Lightbulb, Minimize2, Layers, Scan, Edit3, Eye, EyeOff, Mail, LogIn, FileEdit, UserCheck, FileSignature, BookOpen, Calendar, Minus, Square, FileSymlink, SlidersHorizontal, Search, FileBox, FileDigit, CloudLightning, Pause, Copy, Share2, Info, Compass, RotateCcw, RotateCw } from 'lucide';
